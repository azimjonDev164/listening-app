...
import part1 from "../../audios/listening2/Part 1.mp3";
import part2 from "../../audios/listening2/Part 2.mp3";
import part3 from "../../audios/listening2/Part 3.mp3";
import part4 from "../../audios/listening2/Part 4.mp3";
        ...
        <>
          <section id="part1" className="p-6 max-w-4xl mx-auto">
            ...
            <audio className="w-full" controls>
              <source src={part1} type="audio/mp3" />
              Your browser does not support the audio element.
            </audio>

            <div className="space-y-8 text-gray-800">
              <div>
                <h2 className="text-xl font-semibold mb-2">Questions 1 - 10</h2>
                <i>Conplete the notes below.</i>
                <p className="mb-4">
                  WriteONE WORDAND/OR A NUMBER for each answer.
                </p>
          ...
          >
            ...
            {/* Video */}
            <audio className="w-full" controls>
              <source src={part2} type="audio/mp3" />
              Your browser does not support the audio element.
            </audio>
          ...
          <section id="part3" className="p-6 max-w-4xl mx-auto">
            ...
            <audio className="w-full" controls>
              <source src={part3} type="audio/mp3" />
              Your browser does not support the audio element.
            </audio>
          ...
          <section id="part4" className="p-6 max-w-4xl mx-auto text-gray-800">
            ...
            <audio className="w-full" controls>
              <source src={part4} type="audio/mp3" />
              Your browser does not support the audio element.
            </audio>
